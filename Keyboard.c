...
const char keySCodes[8][128] =
    // US Layout
    {
        ...
        // BR Layout
        {
            ...
            0, '?', '^', 0, 0x60, '+', 0, 0,         // 80-87    50-57
            CAPS, R_SHFT, ENTER, '{', 0, '}', 0, 0,  // 88-95    58-5F
            0, '|', 0, 0, 0, 0, BKSP, 0,             // 96-103   60-67
            0, '1', 0, '4', '7', 0, 0, 0,            // 104-111  68-6F
            '.', ',', '2', '5', '6', '8', ESC, NUML, // 112-119  70-77
            F11, '+', '3', '-', '*', '9', 0, 0       // 120-127  78-7F
        }};
...
const char keyE0Codes_BR[56] =
    // Layout for brasilian Keyboard for the Keypad
    {
        // Base 10
        0, END, 0, LEFT, HOME, 0, 0, 0,             // 104-111
        INSERT, DEL, DOWN, 0, RIGHT, UP, ESC, NUML, // 112-119
        F11, 0, PDOWN, 0, 0, PUP, SLOCK, 0,         // 120-127
};
    ...
    case PS2STOP:
      ...
      { // PS2DAT == 1
        ...
        else
        {
          ...
          {
             if (Option.KeyboardConfig == CONFIG_BR)
             {
                if (NumLock)
                {
          ...
          {             // a keycode from the numeric keypad
            ...
            else if (Option.KeyboardConfig == CONFIG_BR)
              c = keyE0Codes_BR[Code - 104];
            else
            ...
            case CONFIG_ES: // Spanish Keyboard
              ...
              break;
            case CONFIG_BR: // Brasilian Keyboard
              break;
            }
          else
          {
